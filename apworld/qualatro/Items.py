...
item_table: Dict[str, ItemData] = {
    ...
    "Grand Dad": ItemData(offset + 554),
    "Dimensional Cape": ItemData(offset + 555),
    "Haruka Amami": ItemData(offset + 556),
    "Chad Warden": ItemData(offset + 557),
    "Reader": ItemData(offset + 558),
    "Jerome": ItemData(offset + 559),
    "Beader and Berome": ItemData(offset + 560),
    "JokeXplainer 7000": ItemData(offset + 561),
    "2B": ItemData(offset + 562),
    "Inspector Gadget": ItemData(offset + 563),
    "Ogg": ItemData(offset + 564),
    "Familiar Photo": ItemData(offset + 565),
    "Coconut Gun": ItemData(offset + 566),
    "Slip n' Slide": ItemData(offset + 567),
    "Christmas Spirit": ItemData(offset + 568),
    "Fools' Spirit": ItemData(offset + 569),
    "Golden Necklace": ItemData(offset + 570),
    "Cat Mask": ItemData(offset + 571),
    "Spectrogram": ItemData(offset + 572),
    "Galaxia": ItemData(offset + 573),
    "Dian Shi Ma Li": ItemData(offset + 574),
    "Reverberation": ItemData(offset + 575),
    "Caramelldansen": ItemData(offset + 576),
    "Katamari On The Rocks": ItemData(offset + 577),
    "8-Bit Beast": ItemData(offset + 578),
    "BITES THE DUST": ItemData(offset + 579),
    "Final Goodbye": ItemData(offset + 580),
    "mm2wood": ItemData(offset + 581),
    "Lost Media": ItemData(offset + 582),
    "Replica": ItemData(offset + 583),
    "Color War": ItemData(offset + 584),
    ...
    "Donut IV": ItemData(offset + 590),
    "Donut V": ItemData(offset + 647),
    "Donut VI": ItemData(offset + 648),
    "Donut VII": ItemData(offset + 649),
    "Donut VIII": ItemData(offset + 650),

    "Haltmann's Bill": ItemData(offset + 591),
    "(Beta Mix)": ItemData(offset + 592),
    "The Antonymph": ItemData(offset + 593),
    "1, 2, Joker!": ItemData(offset + 594),
    "jOPer": ItemData(offset + 595),
    "Interior Joker": ItemData(offset + 596),
    "Kazoo": ItemData(offset + 597),
    "Circus": ItemData(offset + 598),
    "Get Lucky": ItemData(offset + 599),
    "Joker but bonus cards are retriggered": ItemData(offset + 600),
    "Dancing Mad": ItemData(offset + 601),
    "Boykisser": ItemData(offset + 602),
    "Pomni": ItemData(offset + 603),
    "Gegagedigedagedago": ItemData(offset + 604),
    "Ride the Raft": ItemData(offset + 605),
    "Crazy Bus": ItemData(offset + 606),
    "Unregistered HyperCam 2": ItemData(offset + 607),
    "Papyrus": ItemData(offset + 608),
    "Cryptid Hunt": ItemData(offset + 609),
    "Kingly Mask": ItemData(offset + 610),
    "Together Now!": ItemData(offset + 611),
    "Shades Dupris": ItemData(offset + 612),
    "Tom \"Milkbowl\" Malone": ItemData(offset + 613),
    "Sphelonious Donk": ItemData(offset + 614),
    "Nobody's Hero": ItemData(offset + 615),
    "JOKER REVEAL!!!": ItemData(offset + 616),
    "Limited Liability Partnership": ItemData(offset + 617),
    "Ajit Pai": ItemData(offset + 618),
    "Nico Nico": ItemData(offset + 619),
    "DJ Professor K.": ItemData(offset + 620),
    "King for Eternity": ItemData(offset + 621),
    "Polar Star": ItemData(offset + 622),
    "Nintendo Power": ItemData(offset + 623),
    "Slider": ItemData(offset + 624),
    "Planet B Ball": ItemData(offset + 625),
    "Wii Shop Channel": ItemData(offset + 626),
    "Ta-Ta-Tax Fraud!": ItemData(offset + 627),
    "SmashUp!": ItemData(offset + 628),
    "Christmas in July": ItemData(offset + 629),
    "LeapFrog Word Whammer Fridge Phonics Set": ItemData(offset + 630),
    "Pizza Roll": ItemData(offset + 631),
    "Hot Cross Buns": ItemData(offset + 632),
    "Takeover Do-over": ItemData(offset + 633),
    "Poké Party": ItemData(offset + 634),
    "Othello World": ItemData(offset + 635),
    "Gadget Room": ItemData(offset + 636),
    "Green de la Bean": ItemData(offset + 637),
    "Lady": ItemData(offset + 638),
    "Stingy": ItemData(offset + 639),
    "Brainless Kitty": ItemData(offset + 640),
    "Evil Brainless": ItemData(offset + 641),
    "Cartoon Gunner": ItemData(offset + 642),
    "[siiva swim]": ItemData(offset + 643),
    "Nozomi": ItemData(offset + 644),
    "The Joker Inside Your Head": ItemData(offset + 645),
    "MissingNo.": ItemData(offset + 646),
}
...
def is_joker(item_name: str) -> bool:
    ...
    return (item_id >= 16 and item_id <= 165) or (item_id >= 551)
