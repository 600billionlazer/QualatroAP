...
class QualatroLocation(Location):
    game: str = "Qualatro"
    ante: str = None
    stake: str = None
    deck: str = None
...
qualatro_location_name_to_id = dict()
qualatro_location_id_to_name = dict()
qualatro_location_id_to_stake = dict()
qualatro_location_id_to_ante = dict()
...
for deck in deck_id_to_name:
    for ante in range(8):
        for stake in range(8):
            ...
            location_id = prev_id
            prev_id += 1
            qualatro_location_name_to_id[location_name] = location_id
            qualatro_location_id_to_name[location_id] = location_name
            qualatro_location_id_to_stake[location_id] = stake + 1
            qualatro_location_id_to_ante[location_id] = ante + 1
