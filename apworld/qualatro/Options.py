...
from .QualatroDecks import deck_id_to_name
...
class CustomTarotBundles(OptionSet):
    ...
    must include the "Archipelago Tarot". Here is a list of all Tarot cards https://qualatrogame.fandom.com/wiki/Tarot_Cards.
...
class CustomPlanetBundles(OptionSet):
    ...
    must include the "Archipelago Belt". Here is a list of all Planet cards https://qualatrogame.fandom.com/wiki/Planet_Cards.
...
class CustomSpectralBundles(OptionSet):
    ...
    must include the "Archipelago Spectral". Here is a list of all Planet cards https://qualatrogame.fandom.com/wiki/Spectral_Cards.
    For the Syntax refer to Custom Tarot Bundles, it's the same here."""
...
class FillerJokers(OptionSet):
    ...
    Valid Jokers:
        ...
        for a full list go to https://qualatrogame.fandom.com/wiki/Category:Jokers
...
@dataclass
class QualatroOptions(PerGameCommonOptions):
